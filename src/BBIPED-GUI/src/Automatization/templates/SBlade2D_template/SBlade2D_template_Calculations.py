...
def UserValues(VariablesToModify):
	...
	_DefinedValues_dict["Blade_F1"]=200 
	_DefinedValues_dict["Blade_F2"]=200 
	...
	_DefinedValues_dict["Blade_Ro"]=500 # b()())lade trailing edge radius
	Blade_Ro = _DefinedValues_dict["Blade_Ro"]
	
	_DefinedValues_dict["Blade_Thickness"]=5 # 
	BladeThickness = _DefinedValues_dict["Blade_Thickness"]
